...
export class GameDataService {
  ...
  fetchGames(){
    this.http.get<Game[]>('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/getGameList.php')
     .subscribe(response => {
  ...
  fetchLibrary(user_id: number){
    this.http.get<Game[]>('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/getLibrary.php', {params: {'user_id': user_id}})
     .subscribe(response => {
        this.gameList.next(response.map(game => ({
          id: game.id,
          name: game.name,
  ...
  fetchDevelopedGames(user_id: number){
    this.http.get<Game[]>('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/getDevelopedGames.php', {params: {'user_id': user_id}})
     .subscribe(response => {
        this.gameList.next(response.map(game => ({
          id: game.id,
          name: game.name,
  ...
  fetchGameData(name: string, game_id: number){
    this.http.get<Data[]>('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/getGameData.php', {params: {'name': name, 'game_id': game_id}})
     .subscribe(response => {
  ...
  fetchGameDataIndex(game_id: number){
    this.http.get<DataIndex[]>('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/getGameDataIndex.php', {params: {'game_id': game_id}})
     .subscribe(response => {
  ...
  createDataTable(name: string, gameId: number) {
    this.http.get('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/createNewDataParameter.php', {params: {'game_id': gameId, 'name': name}})
    .subscribe(response => {
  ...
  deleteParameter(name: string, gameId: number) {
    this.http.get('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/deleteDataParameter.php', {params: {'game_id': gameId, 'name': name}})
    .subscribe(response => {
      console.log(response);
     });
  }
  ...
  addToLibrary(gameId: number, userId: number) {
    this.http.get('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/addToLibrary.php', {params: {'game_id': gameId, 'user_id': userId}})
    .subscribe(response => {
  ...
  removeFromLibrary(gameId: number, userId: number) {
    this.http.get('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/removeFromLibrary.php', {params: {'game_id': gameId, 'user_id': userId}})
    .subscribe(response => {
      console.log(response);
     });
  }
  ...
  publishGame(name: string, description: string, creatorId: number, file: File, image: File){
    this.http.get<any>('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/publishGame.php', {params: {'name':name, 'description':description, 'creator_id': creatorId}})
    .subscribe(response => {
      console.log(response);
      if(file){
  ...
  uploadGameFile(file: File, name: string ){
    ...
    return this.http.post<any>('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/saveGameFiles.php', formData);
  }

  deleteGame(gameId: number, gameName: string){
    this.http.get('http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/removeGame.php', {params: {'game_id': gameId, 'game_name': gameName}})
    .subscribe(response => {
      console.log(response);
    });
  }
