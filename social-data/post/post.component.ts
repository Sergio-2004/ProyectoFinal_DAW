...
export class PostComponent implements OnInit {
  ...
  getPostImageUrl(): string {
    return `http://localhost:8000/ProyectoFinal_DAW-main/HTMLRequests/getPostImage.php?forum_id=${this._route.snapshot.params['forum_id']}&post_title=${this.post.title}.png`;
  }
